...
import { ResumeContent, ResumeTemplate } from "@shared/schema";
import { 
  Card, 
  CardContent, 
  CardFooter,
...
export default function ResumePreview({ resumeData, template }: ResumePreviewProps) {
  ...
  const templateStyles: Record<ResumeTemplate, {
    ...
    modern: {
      ...
      sectionTitle: "text-primary-600 dark:text-primary-400 border-b border-primary-200 dark:border-primary-800",
    ...
    professional: {
      ...
      sectionTitle: "text-blue-600 dark:text-blue-400 border-b border-blue-200 dark:border-blue-800",
    ...
    creative: {
      ...
      sectionTitle: "text-purple-600 dark:text-purple-400 border-b border-purple-200 dark:border-purple-800",
    ...
    simple: {
      ...
      sectionTitle: "text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-700",
    ...
    elegant: {
      ...
      sectionTitle: "text-amber-600 dark:text-amber-400 border-b border-amber-200 dark:border-amber-800",
  ...
  const handleDownload = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Resume ready",
        description: "Your resume would be downloaded as a PDF in the full version",
      });
    }, 1500);
  };
        ...
        <CardHeader>
          <CardTitle className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button variant="outline" size="sm" onClick={zoomIn} disabled={scale >= 1.5}>
                +
              </Button>
            </div>
          </CardTitle>
            ...
            >
              ...
              <div className="p-6 space-y-5">
                ...
                {resumeData.personalInfo.summary && (
                  <div>
                    <h3 className={`text-lg font-semibold pb-1 mb-2 ${sectionTitle}`}>
                ...
                {resumeData.experience && resumeData.experience.length > 0 && (
                  <div>
                    <h3 className={`text-lg font-semibold pb-1 mb-3 ${sectionTitle}`}>
                      Work Experience
                    </h3>
                    <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      {resumeData.education.map((edu, index) => (
                        <div key={edu.id || index} className="space-y-1">
                          <div className="flex justify-between">
                            <h4 className="font-medium">{edu.institution || "Institution"}</h4>
                            <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                              <Calendar className="mr-1 h-3 w-3" />
